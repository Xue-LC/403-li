...
export const AVAILABLE_FONTS = [
  ...
  { name: 'Big Money-ne', label: 'Big Money-ne - 金钱' },
  { name: 'Big Money-nw', label: 'Big Money-nw - 金钱' },
  { name: 'Big Money-se', label: 'Big Money-se - 金钱' },
  { name: 'Big Money-sw', label: 'Big Money-sw - 金钱' },
  ...
  { name: 'Efti Chess', label: 'Efti Chess - 国际象棋' },
  { name: 'Efti Font', label: 'Efti Font' },
  { name: 'Efti Italic', label: 'Efti Italic - 斜体' },
  ...
  { name: 'JS Block Letters', label: 'JS Block Letters - JS方块' },
  { name: 'JS Bracket Letters', label: 'JS Bracket Letters - JS括号' },
  { name: 'JS Capital Curves', label: 'JS Capital Curves - JS曲线' },
  { name: 'JS Cursive', label: 'JS Cursive - JS草书' },
  { name: 'JS Stick Letters', label: 'JS Stick Letters - JS细线' },
  ...
  { name: 'S Blood', label: 'S Blood - 血' },
  { name: 'SL Script', label: 'SL Script - SL手写' },
  ...
  { name: 'Wow', label: 'Wow - 哇' },
  { name: 'miniwi', label: 'miniwi - 迷你' }
];
