...
export const AVAILABLE_FONTS = [
  ...
  { name: '20Matrix', label: '20Matrix - 矩阵' },
  { name: '20Mini', label: '20Mini - 迷你' },
  ...
  { name: '20Neko', label: '20Neko - 猫' },
  { name: '20Oblique', label: '20Oblique - 斜体' },
  { name: '20Pepper', label: '20Pepper' },
  { name: '20Phoenix', label: '20Phoenix - 凤凰' },
  { name: '20Piti', label: '20Piti' },
  { name: '20Point', label: '20Point' },
  { name: '20Poison', label: '20Poison - 毒药' },
  { name: '20Power', label: '20Power - 力量' },
  { name: '20Razor', label: '20Razor' },
  { name: '20Razor2', label: '20Razor2' },
  { name: '20Rebel', label: '20Rebel' },
  { name: '20Regular', label: '20Regular - 常规' },
  { name: '20Relief', label: '20Relief' },
  { name: '20Right', label: '20Right - 右' },
  { name: '20Robot', label: '20Robot - 机器人' },
  { name: '20Roman', label: '20Roman - 罗马' },
  { name: '20S', label: '20S' },
